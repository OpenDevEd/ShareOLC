package com.android.sharepluscode.base;
...
public class Locality {
    ...
    public static String getNearestLocality(OpenLocationCode location) throws NoLocalityException {
        ...
        OpenLocationCode.CodeArea locationArea = location.decode();
     ...
     * @return the locality full layout_code, or an empty string if not found.
     */
    ...
    /**
     *6Note: The search for currentLocation and mapLocation locality is done locally only.
     *
    ...
    // List of OLC codes and locality names. This must be sorted by OLC layout_code.
