...
public class JSConstant {
    ...
    public static final int JSEVENT_STAGE3 = 1003;
    public static final int JSEVENT_STAGE4 = 1004;
    public static final int JSEVENT_STAGE5 = 1005;
    public static final int JSEVENT_STAGE_END = 1006;
}
